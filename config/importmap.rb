...
# source it also set up is still defined, for its own use, by
# target_name_for_copy_instances.js below.
...
# All five name-author fields (Author, Base, Ex, Ex Base, Sanctioning) now
