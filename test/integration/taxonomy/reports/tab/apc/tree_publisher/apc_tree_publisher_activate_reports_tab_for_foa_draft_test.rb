...
class APCTreePublisherActivateTreeReportsTabForFOADraft < ActionController::TestCase
  ...
  test "APC tree publisher cannot activate tree reports tab for FOA draft" do
