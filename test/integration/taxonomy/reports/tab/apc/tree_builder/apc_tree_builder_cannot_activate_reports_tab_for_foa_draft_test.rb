...
class APCTreeBuilderCannotActivateTreeReportsTabForFOADraft < ActionController::TestCase
  ...
  test "APC tree builder cannot activate tree reports tab for FOA draft" do
