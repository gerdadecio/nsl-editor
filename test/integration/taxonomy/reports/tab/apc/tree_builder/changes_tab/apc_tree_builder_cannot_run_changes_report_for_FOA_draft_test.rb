...
class APCTreeBuilderCannotRunChangesReportForFOADraftTest < ActionController::TestCase
  ...
  test "APC tree builder cannot run changes report for FOA draft" do
    ...
    get(:run_diff,
         ...
         session: { username: user.user_name,
                    ...
                    draft: draft,
                    groups: ["login"]})
    assert_response :forbidden, 'APC tree builder should not be able to run changes report for FOA draft'
  end
end
