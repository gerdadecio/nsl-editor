...
class TaxoInstanceTreePublisherFoaCannotSeeAPCTreeTab < ActionController::TestCase
  tests InstancesController

  test "foa tree publisher cannot see instance tree tab for APC version" do
