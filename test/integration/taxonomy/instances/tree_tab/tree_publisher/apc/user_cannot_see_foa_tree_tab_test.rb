...
class TaxoInstanceTreePublisherAPCCannotSeeFOATreeTab < ActionController::TestCase
  tests InstancesController

  test "apc tree publisher cannot see instance tree tab for FOA version" do
