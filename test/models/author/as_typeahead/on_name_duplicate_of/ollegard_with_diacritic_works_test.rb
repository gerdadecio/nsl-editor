...
class AuthATAHOnNameDupeOfOllegaardWDiacWorksTest < ActiveSupport::TestCase
  test "author ollegaard with diacritic works" do
    results = Author::AsTypeahead.on_name_duplicate_of("Øllegaard")
