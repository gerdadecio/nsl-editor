...
class AuthorAsTheadOnNameOUmlautFindsOAndOUmlautTest < ActiveSupport::TestCase
  test "author o umlaut finds o and o umlaut test" do
    results = Author::AsTypeahead.on_name("Döll,")
