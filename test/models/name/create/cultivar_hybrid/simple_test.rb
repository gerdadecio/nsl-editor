...
class NameCreateCultivarHybridTest < ActiveSupport::TestCase
  def setup
    setup1
    setup2
  end
  ...
  def setup1
    ...
    @name_params = {
      "name_type_id" => name_type.id.to_s,
  ...
  test "simple" do
    ...
    assert name.name_path == "Plantae/Magnoliophyta/a_family/a_genus/a_species/#{@name_element}"
    assert name.valid?,
