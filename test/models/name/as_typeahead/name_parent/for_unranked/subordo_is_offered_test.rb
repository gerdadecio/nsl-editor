...
class NameParentSubordoIsOfferedForUnrankedTest < ActiveSupport::TestCase
  test "name parent suggestion for unranked include subordo" do
    typeahead = Name::AsTypeahead::ForParent.new(
      term: "a_subordo",
      avoid_id: 1,
      rank_id: NameRank.find_by(name: "[unranked]").id,
    )
    expected_ranks = ["Subordo"]
