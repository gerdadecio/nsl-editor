...
class TypeaheadForSynonymyNothomorphTest < ActiveSupport::TestCase
  def setup
    @ta = Instance::AsTypeahead::ForSynonymy.new(
      "a",
      names(:a_nothomorph_with_an_instance).id,
    )
  end

  test "instance typeahead for synonymy rank restriction for nothomorphmorph" do
