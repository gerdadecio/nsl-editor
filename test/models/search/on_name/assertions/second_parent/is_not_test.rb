...
class SearchOnNameAssertionSecondParentIsNotTest < ActiveSupport::TestCase
  test "name asertion is not a second parent" do
    search = Search::Base.new(ActiveSupport::HashWithIndifferentAccess.new(
      query_target: "name",
      query_string: "is-not-a-second-parent:",
