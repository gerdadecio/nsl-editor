...
class SearchOnNameAcceptedTreeAcceptedInTest < ActiveSupport::TestCase
  test "search accepted names in the accepted tree" do
    params = ActiveSupport::HashWithIndifferentAccess.new(
      query_target: "name",
      query_string: "angophora accepted-in-accepted-tree:",
