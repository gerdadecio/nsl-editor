...
class ReferencePartNoPublicationDateAllowedTest < ActiveSupport::TestCase
  test "reference part no publication date allowed" do
    ...
    reference.publication_date = "xyz"

    err_string = "A reference part with a publication date should be invalid"
