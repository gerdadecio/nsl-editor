...
class TAOnCitnForDupleWildcardsTransAsteriskToPercent < ActiveSupport::TestCase
  test "ref typeahead on citation 4 dupe wildcards translates ast to percent" do
