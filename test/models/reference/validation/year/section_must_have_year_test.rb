...
class RefValYearSectionMustHaveYearTest < ActiveSupport::TestCase
  def setup
    @reference = references(:ref_type_is_section)
    @reference.iso_publication_date = 2000
  end

  test "ref of type section must have a iso_publication_date" do
