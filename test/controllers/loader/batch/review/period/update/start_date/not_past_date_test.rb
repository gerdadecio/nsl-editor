...
class BatchReviewPeriodUpdateStartDatePastDateNotAllowedTest < ActionController::TestCase
  tests ::Loader::Batch::Review::PeriodsController

  test "update batch review period start date not past date" do
    ...
    assert_match(/Error: Validation failed: Start date cannot be in the past/,
                 response.body.to_s,
