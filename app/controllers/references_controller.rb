...
class ReferencesController < ApplicationController
  ...
  def create
    check_date_params
    @reference = Reference::AsEdited.create(
      reference_params,
      typeahead_params,
  ...
  def update_reference
    ...
    @message = @reference.update_if_changed(
      reference_params,
      typeahead_params,
      current_user.username,
    )
  ...
  def check_date_params
    raise "Month entered but no year" if reference_params[:year].blank? && reference_params[:month].present?
    return if reference_params[:month].present?
    raise "Day entered but no month" if reference_params[:day].present?
  end
end
